...
static refalrts::FnResult Test(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    if( ! refalrts::alloc_open_call( n10 ) )
      return refalrts::cNoMemory;
    refalrts::Iter n11 = 0;
    if( ! refalrts::alloc_name( n11, & PrintPattern, "PrintPattern" ) )
      return refalrts::cNoMemory;
    refalrts::Iter n12 = 0;
    ...
    if( ! refalrts::alloc_open_call( n23 ) )
      return refalrts::cNoMemory;
    refalrts::Iter n24 = 0;
    if( ! refalrts::alloc_name( n24, & MakePatterns, "MakePatterns" ) )
      return refalrts::cNoMemory;
    refalrts::Iter n25 = 0;
    ...
    if( ! refalrts::alloc_open_call( n27 ) )
      return refalrts::cNoMemory;
    refalrts::Iter n28 = 0;
    if( ! refalrts::alloc_name( n28, & PrintPattern, "PrintPattern" ) )
      return refalrts::cNoMemory;
    refalrts::Iter n29 = 0;
    ...
    if( ! refalrts::alloc_open_call( n39 ) )
      return refalrts::cNoMemory;
    refalrts::Iter n40 = 0;
    if( ! refalrts::alloc_name( n40, & HardGen, "HardGen" ) )
      return refalrts::cNoMemory;
    refalrts::Iter n41 = 0;
    if( ! refalrts::alloc_open_call( n41 ) )
      return refalrts::cNoMemory;
    refalrts::Iter n42 = 0;
    if( ! refalrts::alloc_name( n42, & MakePatterns, "MakePatterns" ) )
      return refalrts::cNoMemory;
    refalrts::Iter n43 = 0;
    ...
    if( ! refalrts::alloc_open_call( n46 ) )
      return refalrts::cNoMemory;
    refalrts::Iter n47 = 0;
    if( ! refalrts::alloc_name( n47, & PrintPattern, "PrintPattern" ) )
      return refalrts::cNoMemory;
    refalrts::Iter n48 = 0;
    ...
    if( ! refalrts::alloc_open_call( n59 ) )
      return refalrts::cNoMemory;
    refalrts::Iter n60 = 0;
    if( ! refalrts::alloc_name( n60, & MakeIndexes, "MakeIndexes" ) )
      return refalrts::cNoMemory;
    refalrts::Iter n61 = 0;
    if( ! refalrts::alloc_open_call( n61 ) )
      return refalrts::cNoMemory;
    refalrts::Iter n62 = 0;
    if( ! refalrts::alloc_name( n62, & EraseBr, "EraseBr" ) )
      return refalrts::cNoMemory;
    refalrts::Iter n63 = 0;
    if( ! refalrts::alloc_open_call( n63 ) )
      return refalrts::cNoMemory;
    refalrts::Iter n64 = 0;
    if( ! refalrts::alloc_name( n64, & FastGen, "FastGen" ) )
      return refalrts::cNoMemory;
    refalrts::Iter n65 = 0;
    if( ! refalrts::alloc_open_call( n65 ) )
      return refalrts::cNoMemory;
    refalrts::Iter n66 = 0;
    if( ! refalrts::alloc_name( n66, & HardGen, "HardGen" ) )
      return refalrts::cNoMemory;
    refalrts::Iter n67 = 0;
    if( ! refalrts::alloc_open_call( n67 ) )
      return refalrts::cNoMemory;
    refalrts::Iter n68 = 0;
    if( ! refalrts::alloc_name( n68, & MakePatterns, "MakePatterns" ) )
      return refalrts::cNoMemory;
    refalrts::Iter n69 = 0;
    ...
    if( ! refalrts::alloc_close_call( n78 ) )
      return refalrts::cNoMemory;
    refalrts::Iter n79 = 0;
    if( ! refalrts::alloc_open_call( n79 ) )
      return refalrts::cNoMemory;
    refalrts::Iter n80 = 0;
    if( ! refalrts::alloc_name( n80, & WriteLine, "WriteLine" ) )
      return refalrts::cNoMemory;
    refalrts::Iter n81 = 0;
    ...
    refalrts::link_brackets( n48, n57 );
    ...
    refalrts::link_brackets( n29, n38 );
